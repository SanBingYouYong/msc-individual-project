...
def score_near(asset_layout: Layout, target_layout: Layout, max_distance: float, extends_in_front: bool = False) -> float:
    ...
    if extends_in_front:
        ...
        # We need to consider the relative orientation for "in front".
        # Assuming Sofa faces +X (yaw=0) and Rug is also generally aligned.
        # If Sofa is rotated, this needs to be more complex.
        # For simplicity, let's assume the primary axis of "front" is X for both.
...
if __name__ == "__main__":
    ...
    # Reduced number of trials to prevent timeout.
    num_trials = 1000 
